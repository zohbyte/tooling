 ...
 */
import { Event, TagEvent, ConverterEvent, PcapStatsEvent, ConfigEvent, WebhooksEvent, DiscordWebhooksEvent, PcapOverIPEndpointsEvent } from "./websocket";
...
export function isDiscordWebhooksEvent(obj: unknown): obj is DiscordWebhooksEvent {
    const typedObj = obj as DiscordWebhooksEvent
    return (
        (typedObj !== null &&
            typeof typedObj === "object" ||
            typeof typedObj === "function") &&
        typedObj["Type"] === "discordWebhooksUpdated" &&
        Array.isArray(typedObj["DiscordWebhooks"]) &&
        typedObj["DiscordWebhooks"].every((e: any) =>
            typeof e === "string"
        )
    )
}
