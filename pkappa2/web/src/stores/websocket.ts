...
/** @see {isDiscordWebhooksEvent} ts-auto-guard:type-guard */
export type DiscordWebhooksEvent = {
    ...
    ws.onmessage = (event) => {
      ...
      switch (e.Type) {
        ...
        case "webhooksUpdated":
          ...
          break;
        case "discordWebhooksUpdated":
          if (!isDiscordWebhooksEvent(e)) {
            console.error("Invalid discord webhooks event:", e);
            return;
          }
          store.discordWebhooks = e.DiscordWebhooks;
          break;
