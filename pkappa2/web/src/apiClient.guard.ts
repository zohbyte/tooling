 ...
 */
import { Error, SearchResult, SearchResponse, StreamData, Statistics, MainStderr, Config, PcapsResponse, ConvertersResponse, ProcessStderr, PcapOverIPResponse, Webhooks, DiscordWebhooks, DiscordWebhookTemplate, TagsResponse, GraphResponse } from "./apiClient";
...
export function isDiscordWebhooks(obj: unknown): obj is DiscordWebhooks {
    const typedObj = obj as DiscordWebhooks
    return (
        Array.isArray(typedObj) &&
        typedObj.every((e: any) =>
            typeof e === "string"
...
export function isDiscordWebhookTemplate(obj: unknown): obj is DiscordWebhookTemplate {
    const typedObj = obj as DiscordWebhookTemplate
    return (
        (typedObj !== null &&
            typeof typedObj === "object" ||
            typeof typedObj === "function") &&
        ...
        (typedObj["MentionUserIDs"] === null ||
            Array.isArray(typedObj["MentionUserIDs"]) &&
            (typedObj["MentionUserIDs"] as any[]).every((e: any) =>
                typeof e === "string"
            ))
    )
}
