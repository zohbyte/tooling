...
/** @see {isDiscordWebhooks} ts-auto-guard:type-guard */
export type DiscordWebhooks = string[];

/** @see {isDiscordWebhookTemplate} ts-auto-guard:type-guard */
export type DiscordWebhookTemplate = {
  Title: string;
  Description: string;
  Color: string;
...
const APIClient = {
  ...
  async getDiscordWebhooks() {
    return this.performGuarded("get", "/discord-webhooks", isDiscordWebhooks);
  },
  async addDiscordWebhook(url: string) {
    return this.perform("put", "/discord-webhooks", null, { url });
  },
  async delDiscordWebhook(url: string) {
    return this.perform("delete", "/discord-webhooks", null, { url });
  },
  async getDiscordWebhookTemplate() {
    return this.performGuarded(
      "get",
  ...
  async setDiscordWebhookTemplate(tmpl: DiscordWebhookTemplate) {
    return this.perform(
      "post",
      "/discord-webhook-template",
      JSON.stringify(tmpl),
